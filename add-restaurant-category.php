...
if(isset($_POST['submit']))
{
  ...
  if(empty($errors))
  {
    ...
    $sql = 'INSERT INTO restaurant_categories (rest_category_name, created_at, updated_at) VALUES (?,?,?)';
    $insert = DB::dbActive()->query($sql, $category);

    if(!$insert)
    {
        $errors[] = 'Restaurant category was not created. Try again later';
    }
    else
    {
